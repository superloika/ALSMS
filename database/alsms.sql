...
-- Dumping structure for table alsms2.classes
...
-- Dumping data for table alsms2.classes: ~4 rows (approximately)
...
-- Dumping structure for table alsms2.clc
...
-- Dumping data for table alsms2.clc: ~1 rows (approximately)
INSERT INTO `clc` (`id`, `name`, `address`, `clc_status`) VALUES
	(1, 'BLC', 'Balilihan', 1);

-- Dumping structure for table alsms2.enrollment
...
-- Dumping data for table alsms2.enrollment: ~3 rows (approximately)
...
-- Dumping structure for table alsms2.failed_jobs
...
-- Dumping data for table alsms2.failed_jobs: ~0 rows (approximately)

-- Dumping structure for table alsms2.migrations
...
-- Dumping data for table alsms2.migrations: ~4 rows (approximately)
...
-- Dumping structure for table alsms2.password_resets
...
-- Dumping data for table alsms2.password_resets: ~0 rows (approximately)

-- Dumping structure for table alsms2.profiles
...
-- Dumping data for table alsms2.profiles: ~1 rows (approximately)
...
-- Dumping structure for table alsms2.programs
...
-- Dumping data for table alsms2.programs: ~2 rows (approximately)
...
-- Dumping structure for table alsms2.sys
CREATE TABLE IF NOT EXISTS `sys` (
  ...
  `created_by` int(11) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='Learning programs';

-- Dumping data for table alsms2.sys: ~0 rows (approximately)
...
-- Dumping structure for table alsms2.teachers
...
-- Dumping data for table alsms2.teachers: ~0 rows (approximately)
...
-- Dumping structure for table alsms2.users
...
-- Dumping data for table alsms2.users: ~10 rows (approximately)
...
-- Dumping structure for table alsms2.websockets_statistics_entries
...
-- Dumping data for table alsms2.websockets_statistics_entries: ~0 rows (approximately)
